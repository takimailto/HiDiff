...
class CrossAttention(nn.Module):
    def __init__(self, embedding_dim, emb_chn, reduction_ratio=1):
        ...
        self.query1 = QuantizeLinear(embedding_dim, embedding_dim)
        self.key1 = QuantizeLinear(embedding_dim, embedding_dim)
        self.value1 = QuantizeLinear(embedding_dim, embedding_dim)
        ...
        if self.reduction_ratio > 1:
            ...
            self.reduction = QuantizeLinear(embedding_dim, embedding_dim)
...
class LayerScaleModule(nn.Module):
    ...
    def __init__(self, embedding_dim, emb_chn):
        super().__init__()
        self.dense = QuantizeLinear(embedding_dim, embedding_dim)
...
class ViTIntermediate(nn.Module):
    def __init__(self, embedding_dim, emb_chn):
        ...
        self.dense = QuantizeLinear(embedding_dim, embedding_dim * self.expansion_ratio)
...
class ViTOutput(nn.Module):
    def __init__(self, embedding_dim, emb_chn):
        super().__init__()
        self.expansion_ratio = 4
        self.dense = QuantizeLinear(embedding_dim * self.expansion_ratio, embedding_dim)
